...
if [ ! -f ${PRETRAINED_CHECKPOINT_DIR}/${MODEL_NAME}.ckpt ]; then
  wget http://download.tensorflow.org/models/${MODEL_NAME}_2016_08_28.tar.gz
  tar -xvf ${MODEL_NAME}_2016_08_28.tar.gz
  mv ${MODEL_NAME}.ckpt ${PRETRAINED_CHECKPOINT_DIR}/${MODEL_NAME}.ckpt
  rm ${MODEL_NAME}_2016_08_28.tar.gz
fi
...
#  --checkpoint_exclude_scopes=resnet_v1_101/logits,resnet_v1_101/my_logits_layers \
#  --trainable_scopes=resnet_v1_101/logits,resnet_v1_101/block4/unit_1,resnet_v1_101/block4/unit_2,resnet_v1_101/block4/unit_3,resnet_v1_101/my_logits_layers \
