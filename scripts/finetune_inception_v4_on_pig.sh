...
# TRAIN_DIR=~/dataset/pig-models/inception_v3_old
TRAIN_DIR=~/dataset/pig-models/inception_v4_with_different_layer_learning_rate/

# Where the dataset is saved to.
DATASET_DIR=~/dataset/pig_test
...
#  --checkpoint_path=${TRAIN_DIR} \
#  --model_name=${MODEL_NAME} \
#  --max_number_of_steps=100000000000 \
#  --batch_size=32 \
#  --learning_rate=0.001 \
#  --save_interval_secs=300 \
#  --save_summaries_secs=300 \
